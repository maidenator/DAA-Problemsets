#ifndef DESIGN_AND_ANALYSIS_OF_ALGORITHMS_MYBINARYTREE_H
#define DESIGN_AND_ANALYSIS_OF_ALGORITHMS_MYBINARYTREE_H
#include <cstdlib>
#include <iostream>
...
#endif //DESIGN_AND_ANALYSIS_OF_ALGORITHMS_MYBINARYTREE_H
